...
(function (AudioContexts) {
    AudioContexts[AudioContexts["CreatePost"] = 0] = "CreatePost";
    AudioContexts[AudioContexts["EditPost"] = 1] = "EditPost";
    AudioContexts[AudioContexts["LikePost"] = 2] = "LikePost";
    AudioContexts[AudioContexts["DeletePost"] = 3] = "DeletePost";
    AudioContexts[AudioContexts["Notification"] = 4] = "Notification";
    AudioContexts[AudioContexts["NewPost"] = 5] = "NewPost";
...
function getAudio(context) {
    let config = null;
    if (typeof context === "object") {
        config = context;
    }
    else {
        let ls = JSON.parse(localStorage.getItem("smiggins-sounds") || "{}") || {};
    ...
    let audio = new Audio(AUDIO_URL + "/" + config.file);
    audio.volume = config.volume;
    return audio;
}
function updateAudioConfig(context, config, playSample = true) {
    let ls = JSON.parse(localStorage.getItem("smiggins-sounds") || "{}") || {};
    ls[context] = config;
...
function _intToBytes(num, length = 1) {
    let arrReverse = new Uint8Array(length);
...
(function (ResponseCodes) {
    ...
    ResponseCodes[ResponseCodes["Mute"] = 22] = "Mute";
    ResponseCodes[ResponseCodes["Unmute"] = 23] = "Unmute";
    ...
    ResponseCodes[ResponseCodes["TimelineScheduled"] = 106] = "TimelineScheduled";
...
class _api_Base {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.NOOP];
        this.url = "/api/noop";
        this.method = "GET";
        this.disabled = [];
...
class _api_TimelineBase extends _api_Base {
    ...
    handle(u8arr) {
        ...
        if (forwards) {
            if (posts.length) {
                playSound(AudioContexts.NewPost);
            }
...
class api_LogIn extends _api_Base {
    constructor(username, password, button) {
        ...
        this.version = API_VERSIONS[ResponseCodes.LogIn];
...
class api_SignUp extends _api_Base {
    constructor(username, password, otp, button) {
        super();
        this.id = ResponseCodes.SignUp;
        this.version = API_VERSIONS[ResponseCodes.SignUp];
        this.url = "/api/user/signup";
        this.method = "POST";
        this.requestBody = buildRequest([username, 8], hexToBytes(sha256(password)), [otp || "", 8]);
        this.disabled = [button];
    }
    handle(u8arr) {
        setTokenCookie(_toHex(u8arr.slice(2)));
...
class api_Follow extends _api_Base {
    constructor(username, button) {
        ...
        this.version = API_VERSIONS[ResponseCodes.Follow];
...
class api_Unfollow extends api_Follow {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.Unfollow];
        this.method = "DELETE";
    }
    handle(u8arr) {
...
class api_Block extends api_Follow {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.Block];
...
class api_Unblock extends api_Block {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.Unblock];
        this.method = "DELETE";
    }
    handle(u8arr) {
...
class api_AcceptFollowRequest extends _api_Base {
    constructor(username) {
        ...
        this.version = API_VERSIONS[ResponseCodes.AcceptFolreq];
...
class api_DenyFollowRequest extends api_AcceptFollowRequest {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.DenyFolreq];
        this.method = "DELETE";
    }
}
class api_Mute extends api_Follow {
    constructor() {
        super(...arguments);
        this.id = ResponseCodes.Mute;
        this.version = API_VERSIONS[ResponseCodes.Mute];
        this.url = "/api/user/mute";
        this.method = "POST";
    }
    handle(u8arr) {
...
class api_Unmute extends api_Mute {
    constructor() {
        super(...arguments);
        this.id = ResponseCodes.Unmute;
        this.version = API_VERSIONS[ResponseCodes.Unmute];
        this.method = "DELETE";
    }
    handle(u8arr) {
...
class api_GetProfile extends _api_Base {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.GetProfile];
        this.url = "/api/user";
        this.method = "GET";
    }
    handle(u8arr) {
...
class api_SaveProfile extends _api_Base {
    constructor(gradient, displayName, bio, pronouns, colorOne, colorTwo, button) {
        ...
        this.version = API_VERSIONS[ResponseCodes.SaveProfile];
        this.url = "/api/user";
        this.method = "PATCH";
        this.disabled = [button];
...
class api_DeleteAccount extends _api_Base {
    constructor(username, password, button) {
        ...
        this.version = API_VERSIONS[ResponseCodes.DeleteAccount];
        this.url = "/api/user";
        this.method = "DELETE";
        this.disabled = [button];
...
class api_ChangePassword extends _api_Base {
    constructor(currentPassword, newPassword, button) {
        ...
        this.version = API_VERSIONS[ResponseCodes.ChangePassword];
...
class api_DefaultVisibility extends _api_Base {
    constructor(defaultPrivate) {
        ...
        this.version = API_VERSIONS[ResponseCodes.DefaultVisibility];
...
class api_VerifyFollowers extends _api_Base {
    constructor(verify) {
        ...
        this.version = API_VERSIONS[ResponseCodes.VerifyFollowers];
...
class api_CreatePost extends _api_Base {
    constructor(content, cw, followersOnly, extra) {
        ...
        this.version = API_VERSIONS[ResponseCodes.CreatePost];
        this.url = "/api/post";
        this.method = "POST";
        this.scheduled = Boolean(extra && extra.scheduled);
        this.requestBody = buildRequest(followersOnly, Boolean(extra && extra.quote), Boolean(extra && extra.poll && extra.poll.length), Boolean(extra && extra.comment), Boolean(extra && extra.scheduled), [content, 16], [cw || "", 8], ...((extra && extra.poll && extra.poll.length) ? [[extra.poll.length, 8], ...extra.poll.map((a) => ([a, 8]))] : []), ...((extra && extra.quote) ? [[extra.quote, 32]] : []), ...((extra && extra.comment) ? [[extra.comment, 32]] : []), ...((extra && extra.scheduled) ? [[extra.scheduled, 64]] : []));
    }
    handle(u8arr) {
...
class api_Like extends _api_Base {
    constructor(pid) {
        ...
        this.version = API_VERSIONS[ResponseCodes.Like];
        this.method = "POST";
...
class api_Unlike extends api_Like {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.Unlike];
        this.method = "DELETE";
    }
    handle(u8arr) { }
}
class api_Pin extends _api_Base {
    constructor(pid) {
        ...
        this.version = API_VERSIONS[ResponseCodes.Pin];
        this.method = "POST";
...
class api_Unpin extends _api_Base {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.Unpin];
...
class api_PollVote extends _api_Base {
    constructor(pid, option) {
        ...
        this.version = API_VERSIONS[ResponseCodes.PollVote];
...
class api_PollRefresh extends api_PollVote {
    constructor(pid) {
        ...
        this.version = API_VERSIONS[ResponseCodes.PollRefresh];
        this.method = "GET";
...
class api_EditPost extends _api_Base {
    constructor(id, content, cw, privatePost, button) {
        ...
        this.version = API_VERSIONS[ResponseCodes.EditPost];
        this.url = "/api/post";
        this.method = "PATCH";
        this.disabled = [button];
...
class api_DeletePost extends _api_Base {
    constructor(pid) {
        ...
        this.version = API_VERSIONS[ResponseCodes.DeletePost];
        this.url = "/api/post";
        this.method = "DELETE";
...
class api_AdminDeleteUser extends _api_Base {
    constructor(username) {
        ...
        this.version = API_VERSIONS[ResponseCodes.AdminDeleteUser];
...
class api_GenerateOTP extends _api_Base {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.GenerateOTP];
...
class api_DeleteOTP extends _api_Base {
    constructor(otp) {
        ...
        this.version = API_VERSIONS[ResponseCodes.DeleteOTP];
        this.url = "/api/admin/invite";
        this.method = "DELETE";
...
class api_ListOTP extends _api_Base {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.ListOTP];
        this.url = "/api/admin/invite";
        this.method = "GET";
    }
    handle(u8arr) {
...
class api_GetAdminPermissions extends _api_Base {
    constructor(username) {
        ...
        this.version = API_VERSIONS[ResponseCodes.GetAdminPermissions];
        this.method = "GET";
...
class api_SetAdminPermissions extends _api_Base {
    constructor(username, val) {
        ...
        this.version = API_VERSIONS[ResponseCodes.SetAdminPermissions];
...
class api_MessageGroupTimeline extends _api_TimelineBase {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.MessageGroupTimeline];
...
class api_MessageTimeline extends _api_TimelineBase {
    constructor(offset, forwards, gid) {
        ...
        this.version = API_VERSIONS[ResponseCodes.MessageTimeline];
        this.method = "GET";
...
class api_MessageSend extends _api_Base {
    constructor(gid, content, input) {
        ...
        this.version = API_VERSIONS[ResponseCodes.MessageSend];
        this.method = "POST";
        this.disabled = [input];
...
class api_MessageGetGID extends _api_Base {
    constructor(usernames, button) {
        ...
        this.version = API_VERSIONS[ResponseCodes.MessageGetGID];
...
class api_TimelineGlobal extends _api_TimelineBase {
    constructor(offset, forwards, comments) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineGlobal];
        this.method = "GET";
...
class api_TimelineFollowing extends _api_TimelineBase {
    constructor(offset, forwards, comments) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineFollowing];
        this.method = "GET";
...
class api_TimelineUser extends _api_TimelineBase {
    constructor(offset, forwards, username, comments) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineUser];
        this.method = "GET";
    ...
    handle(u8arr) {
        ...
        userUpdateStats(displayName[0], pronouns[0], bio[0], "#" + _toHex(bio[1].slice(0, 3)), "#" + _toHex(bio[1].slice(3, 6)), _extractBool(flags, 3) && "pending" || _extractBool(flags, 5), _extractBool(flags, 4), _extractBool(flags, 1), _extractInt(16, bio[1].slice(8)), _extractInt(16, bio[1].slice(6)), _extractInt(16, bio[1].slice(10)), pinned);
...
class api_TimelineComments extends _api_TimelineBase {
    constructor(offset, forwards, pid, sort) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineComments];
        this.method = "GET";
...
class api_TimelineNotifications extends _api_TimelineBase {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineNotifications];
    ...
    handle(u8arr) {
        ...
        let end = _extractBool(u8arr[2], 7);
        let forwards = _extractBool(u8arr[2], 6);
        let numNotifs = u8arr[3];
        let notifs = [];
        u8arr = u8arr.slice(4);
        for (let i = 0; i < numNotifs; i++) {
            let unread = Boolean(u8arr[0] & 0x80);
            let notifData = null;
            let code = u8arr[0] & 0x7F;
            u8arr = u8arr.slice(1);
            switch (code) {
                ...
                case NotificationCodes.Like: {
                    let postId = _extractInt(32, u8arr);
                    let timestamp = _extractInt(64, u8arr.slice(4));
                    let username = _extractString(8, u8arr.slice(12));
                    let displayName = _extractString(8, username[1]);
                    let content = _extractString(16, displayName[1]);
                    let cw = _extractString(8, content[1]);
                    u8arr = cw[1];
                    notifData = {
                        code: code,
                        unread: unread,
                ...
                case NotificationCodes.Follow: {
                    let timestamp = _extractInt(64, u8arr);
                    let username = _extractString(8, u8arr.slice(8));
                    let displayName = _extractString(8, username[1]);
                    u8arr = displayName[1];
                    notifData = {
                        code: code,
...
class api_TimelineHashtag extends _api_TimelineBase {
    constructor(offset, forwards, tag, sort) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineHashtag];
        this.method = "GET";
...
class api_TimelineFolreq extends _api_TimelineBase {
    constructor(offset, _) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineFolreq];
...
class api_TimelineSearch extends _api_TimelineBase {
    constructor(offset, forwards, params, sort) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineSearch];
        this.method = "GET";
...
class api_TimelineUserFollowing extends _api_TimelineBase {
    constructor(offset, username) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineUserFollowing];
        this.method = "GET";
...
class api_TimelineUserFollowers extends api_TimelineUserFollowing {
    constructor(offset, username) {
        ...
        this.version = API_VERSIONS[ResponseCodes.TimelineUserFollowers];
        this.url = `/api/timeline/user/followers/${username}`;
    }
}
class api_TimelineScheduled extends _api_TimelineBase {
    constructor(offset, forwards, sort) {
        super(offset, forwards);
        this.id = ResponseCodes.TimelineScheduled;
        this.version = API_VERSIONS[ResponseCodes.TimelineScheduled];
        this.method = "GET";
...
class api_Notifications extends _api_Base {
    constructor() {
        ...
        this.version = API_VERSIONS[ResponseCodes.Notifications];
    ...
    handle(u8arr) {
        ...
        if (previousNotificationCount != Infinity && ((newPending.notifications && !pendingNotifications.notifications)
...
const keybinds = {
    ...
    navSearch: { defaultKey: "e", modifiers: ["nav"], callback: () => { if (currentPage === "search") {
            return;
        } history.pushState("search", "", "/search/"); renderPage("search"); } },
...
function createPostModal(type, id) {
    ...
    if (type === "edit") {
        (_d = el.querySelector("#modal-post-scheduled-options")) === null || _d === void 0 ? void 0 : _d.setAttribute("hidden", "");
    }
    (_e = el.querySelector("#modal-poll-toggle")) === null || _e === void 0 ? void 0 : _e.addEventListener("click", function () {
        let pollElement = el.querySelector("#modal-poll-area");
        if (pollElement) {
            pollElement.hidden = !pollElement.hidden;
        }
    });
    (_f = el.querySelector("#modal-post-scheduled")) === null || _f === void 0 ? void 0 : _f.addEventListener("input", function () {
        var _a, _b, _c;
        if ((_a = el.querySelector("#modal-post-scheduled")) === null || _a === void 0 ? void 0 : _a.checked) {
            (_b = el.querySelector("#modal-post-scheduled-date")) === null || _b === void 0 ? void 0 : _b.removeAttribute("hidden");
        }
        else {
            (_c = el.querySelector("#modal-post-scheduled-date")) === null || _c === void 0 ? void 0 : _c.setAttribute("hidden", "");
        }
    });
...
function createRelationshipHelpModal() {
    var _a;
...
function postModalCreatePost(e) {
    ...
    let scheduledCheckElement = document.getElementById("modal-post-scheduled");
    let scheduledDateElement = document.getElementById("modal-post-scheduled-date");
    if (!cwElement || !contentElement || !privatePostElement || !scheduledCheckElement || !scheduledDateElement) {
        return;
    }
    let cw = cwElement.value;
    let content = contentElement.value;
    let privatePost = privatePostElement.checked;
    let scheduled = scheduledCheckElement.checked ? Math.floor(scheduledDateElement.valueAsNumber / 1000) : undefined;
    let poll = [];
...
function renderPage(intent) {
    ...
    switch (intent) {
        ...
        case "settings/cosmetic":
            extraVariables = {
                language_selection: Object.values(LANGS).map((a) => (`<option value="${a.meta.id}">${escapeHTML(a.meta.name)}</option>`)).join(""),
        ...
        case "settings/account":
            ...
            break;
        case "settings/about":
            let maintainerMap = (a) => (a[0] ? `<li><a target="_blank" href="https://github.com/${a[0]}/">${escapeHTML(a[1])}</a></li>` : `<li>${escapeHTML(a[1])}</li>`);
            let translators = "";
...
let previousNotificationCount = Infinity;
...
function _extractPost(data) {
    ...
    let scheduled = [_extractBool(flags[1], 3), _extractBool(flags[1], 2)];
...
const icons = {
    ...
    logo: '<svg viewBox="0 0 504 502" xmlns="http://www.w3.org/2000/svg" stroke-linecap="round" stroke-linejoin="round" class="svg-stroke-no-fill"><path d="M420.616 441.726c-33.083 21.218-132.19 50.567-208.6 34.526C108.812 454.585 41.73 394.066 39.73 275.263c-.415-24.665 4.209-48.362 11.947-70.4l-30.02-148.37a23.75 23.75 0 0 1 28.737-29.242l128.14 48.527c23.019-8.539 47.911-13.205 73.885-13.205 24.669 0 48.362 4.209 70.4 11.947l129.527-52.862a23.75 23.75 0 0 1 29.241 28.736L451.904 201.38c8.54 23.018 13.205 47.91 13.205 73.884 0 63.54-37.185 115.176-77.54 102.298-15.689-5.005-32.917-24.481-42.75-56.657-11.924-39.019-12.973-93.889 12.79-128.052" stroke-width="41.666"/><path d="M2010 2850c80.547-19.129 150 67.213 150 150s-70.296 190.604-150.374 211.608c-212.663 55.78-206.462-312.488.374-361.608" transform="matrix(.53031 0 0 .51095 -818.893 -1286.667)" stroke-width="72.02"/></svg>',
    ...
    schedule: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="63 63 514 514"><path d="M528 320c0 114.9-93.1 208-208 208s-208-93.1-208-208 93.1-208 208-208 208 93.1 208 208m-464 0c0 141.4 114.6 256 256 256s256-114.6 256-256S461.4 64 320 64 64 178.6 64 320m232-136v136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L344 307.2V184c0-13.3-10.7-24-24-24s-24 10.7-24 24"/></svg>',
    schedule_active: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="63 63 514 514"><path d="M320 64c141.4 0 256 114.6 256 256S461.4 576 320 576 64 461.4 64 320 178.6 64 320 64m-24 120v136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L344 307.2V184c0-13.3-10.7-24-24-24s-24 10.7-24 24"/></svg>'
};
...
function getSnippet(snippet, extraVariables) {
    ...
    for (const i of content.matchAll(/@\{lang((?:\.[a-z_0-9]+)+)\}/ig)) {
        content = content.replace(i[0], langFromRaw(i[1].slice(1)));
    }
...
function swRegHandler(registration) {
    registration.pushManager.getSubscription()
        .then((subscription) => __awaiter(this, void 0, void 0, function* () {
        if (subscription) {
            console.log("[SW] subscription exists");
            return subscription;
        }
        let register = loggedIn && Boolean(localStorage.getItem("smiggins-push-notifs")) && (yield canUseNotifications());
        if (!register) {
            console.log("[SW] not listening");
            return null;
        }
        const response = yield fetch("/api/sw/publickey");
        const publicKey = yield response.text();
...
function askNotificationPermission() {
    return __awaiter(this, void 0, void 0, function* () {
        if (window.Notification && !(yield canUseNotifications())) {
            return yield Notification.requestPermission();
        }
    });
}
function _swPostMessage(message) {
    navigator.serviceWorker.ready.then((w) => {
        var _a;
        (_a = (w.active || w.waiting || w.installing)) === null || _a === void 0 ? void 0 : _a.postMessage(message);
    });
}
function swSetLanguage() {
    _swPostMessage("l" + (localStorage.getItem("smiggins-language") || DEFAULT_LANGUAGE));
}
function swUpdateBadge(count) {
    _swPostMessage("b" + String(count));
}
function swClearNotifs() {
    _swPostMessage("c");
}
initServiceWorker();
let themeMedia = matchMedia("(prefers-color-scheme: light)");
let _themeLs = localStorage.getItem("smiggins-theme");
let _faviLs = localStorage.getItem("smiggins-favicon");
let theme = _themeLs === "light" || _themeLs === "dark" || _themeLs === "warm" || _themeLs === "gray" || _themeLs === "darker" || _themeLs === "oled" ? _themeLs : "system";
let favicon = _faviLs === "light" || _faviLs === "dark" || _faviLs === "old" || _faviLs === "pq-light" || _faviLs === "pq-dark" || _faviLs === "cat-light" || _faviLs === "cat-dark" ? _faviLs : "system";
...
function updateFavicon(favi) {
    ...
    switch (favi) {
        ...
        case "light":
            ...
            break;
        case "pq-dark":
            filename = "favicon-pq-dark.png";
            break;
        case "pq-light":
            filename = "favicon-pq-light.png";
            break;
        case "cat-dark":
            filename = "favicon-cat-dark.png";
            break;
        case "cat-light":
            filename = "favicon-cat-light.png";
            break;
        case "old":
            filename = "old_favicon.png";
            break;
    }
    if (!filename) {
        return;
...
function checkOffsetUpdate(post) {
    checkOffsetUpdateRaw(post.timestamp, post.id);
}
function checkOffsetUpdateRaw(ts, id) {
...
function checkOffsetHigher(possibleNewer, current) {
    if (possibleNewer === null) {
        return false;
    }
    if (current === null) {
        return true;
...
function checkOffsetLower(possibleOlder, current) {
    if (possibleOlder === null) {
        return false;
    }
    if (current === null) {
        return true;
...
function handleForward(posts, end, expectedTlID, forceEvent = false) {
    ...
    let countWithoutPrepended = c.pendingForward.length + posts.length - prependedPosts;
    ...
    if (end) {
        checkOffsetUpdate(posts.reduce((a, b) => (checkOffsetHigher([a.timestamp, a.id], [b.timestamp, b.id]) ? a : b)));
        c.pendingForward.push(...insertIntoPostCache(posts).reverse());
...
function postButtonClick(e) {
    ...
    if (el.dataset.interactionQuote) {
        ...
        if (!liked) {
            playSound(AudioContexts.LikePost);
        }
    }
...
function simplePostContent(post, cw, hasPoll) {
    let content;
...
function createToast(title, content, timeout, type = "info") {
    var _a;
    if (!title) {
        return;
    }
...
function p_home(element) {
    ...
    (_c = element.querySelector("#post-scheduled")) === null || _c === void 0 ? void 0 : _c.addEventListener("input", function () {
        var _a, _b, _c;
        if ((_a = element.querySelector("#post-scheduled")) === null || _a === void 0 ? void 0 : _a.checked) {
            (_b = element.querySelector("#post-scheduled-date")) === null || _b === void 0 ? void 0 : _b.removeAttribute("hidden");
        }
        else {
            (_c = element.querySelector("#post-scheduled-date")) === null || _c === void 0 ? void 0 : _c.setAttribute("hidden", "");
        }
    });
}
...
function homeCreatePost(e) {
    ...
    let scheduledCheckElement = document.getElementById("post-scheduled");
    let scheduledDateElement = document.getElementById("post-scheduled-date");
    if (!cwElement || !contentElement || !privatePostElement || !scheduledCheckElement || !scheduledDateElement) {
        return;
    }
    let cw = cwElement.value;
    ...
    createPost(content, cw || null, privatePost, (success) => {
        ...
        if (success) {
            ...
            scheduledDateElement === null || scheduledDateElement === void 0 ? void 0 : scheduledDateElement.setAttribute("hidden", "");
...
function signupSubmitEvent(e) {
    ...
    if (otpElement && !otp) {
        ...
        createToast(L.errors.passwords_dont_match, undefined, undefined, "error");
        return;
    }
    new api_SignUp(username, password, otp, e.target).fetch();
}
...
function renderMessageTimeline(messages, end, _, moreElementOverride, prepend = false) {
    ...
    for (const message of messages) {
        checkOffsetUpdateRaw(message.timestamp, 0);
...
(function (NotificationCodes) {
    ...
    NotificationCodes[NotificationCodes["Follow"] = 5] = "Follow";
...
function _getLikeNotification(likes) {
    let recentTimestamp = 0;
    let users = likes.map((a) => {
    ...
    let userFull = lr(n(L.notifications.like, likes.length), {
        a: users[0],
        b: users[1],
        c: users[2],
...
function _getFollowNotification(follows) {
    let recentTimestamp = 0;
    let users = follows.map((a) => {
        if (a.timestamp > recentTimestamp) {
            recentTimestamp = a.timestamp;
        }
        return [a.username, a.display_name];
    ...
    let userFull = lr(n(L.notifications.follow, follows.length), {
        a: users[0],
        b: users[1],
        c: users[2],
...
function renderNotificationTimeline(notifs, end, _, moreElementOverride, prepend = false) {
    ...
    for (const notif of notifs) {
        checkOffsetUpdateRaw(notif.code === NotificationCodes.Like || notif.code === NotificationCodes.Follow ? notif.timestamp : notif.post.timestamp, 0);
        ...
        if (notif.code === NotificationCodes.Like) {
            ...
            if (localStorage.getItem("smiggins-no-like-grouping")) {
                let el = _getLikeNotification([notif]);
                if (!notif.unread) {
                    el.dataset.notificationRead = "";
                }
                frag.append(el);
            ...
            pendingLikeOrder = [];
            if (localStorage.getItem("smiggins-no-like-grouping")) {
                let el = _getFollowNotification([notif]);
                if (!notif.unread) {
                    el.dataset.notificationRead = "";
                }
                frag.append(el);
            ...
            pendingLikeOrder = [];
            pendingFollows = [];
            let el = getPost(insertIntoPostCache([notif.post])[0], false);
            if (!notif.unread) {
                el.dataset.notificationRead = "";
            }
            frag.append(el);
...
function pushPending(frag, pendingLikes, pendingLikeOrder, pendingFollows) {
    if (pendingLikeOrder.length) {
        ...
        let el = _getFollowNotification(pendingFollows);
...
function handleNotificationForward(notifs, end, expectedTlID = "notifications", _ = false) {
    tlPollingPendingResponse = false;
    if ("notifications" !== currentTlID) {
        console.log("timeline switched, discarding request");
        return;
...
function saveProfile(e) {
    ...
    new api_SaveProfile(gradientCheckElement.checked, displayNameElement.value, bioElement.value, pronounsElement && pronounsCustomElement ? (pronounsElement.value === "custom" ? pronounsCustomElement.value : pronounsElement.value) : "", c1Element.value.slice(1), c2Element.value.slice(1), e.target).fetch();
}
...
function settingsFaviconSelection() {
    let faviconElement = document.getElementById("favicon-sel");
    if (faviconElement) {
        let favi = faviconElement.value;
        setFavicon(favi);
    }
}
...
function exportSettings() {
    let settings = {
        ...
        favicon: localStorage.getItem("smiggins-favicon") || "system",
        ...
        language: localStorage.getItem("smiggins-language") || L.meta.id,
...
function disablePushNotifications() {
    ...
    killServiceWorker();
    (_a = document.getElementById("disable-push-notifs")) === null || _a === void 0 ? void 0 : _a.setAttribute("hidden", "");
    (_b = document.getElementById("enable-push-notifs")) === null || _b === void 0 ? void 0 : _b.removeAttribute("hidden");
}
function enablePushNotifications() {
    var _a, _b, _c, _d;
    (_a = document.getElementById("enable-push-notifs")) === null || _a === void 0 ? void 0 : _a.setAttribute("disabled", "");
    if (Notification.permission === "granted") {
        initServiceWorker();
        (_b = document.getElementById("enable-push-notifs")) === null || _b === void 0 ? void 0 : _b.removeAttribute("disabled");
        (_c = document.getElementById("enable-push-notifs")) === null || _c === void 0 ? void 0 : _c.setAttribute("hidden", "");
        (_d = document.getElementById("disable-push-notifs")) === null || _d === void 0 ? void 0 : _d.removeAttribute("hidden");
    ...
    askNotificationPermission()
        .then((perms) => {
        var _a, _b, _c, _d, _e;
        (_a = document.getElementById("enable-push-notifs")) === null || _a === void 0 ? void 0 : _a.removeAttribute("disabled");
        if (perms === "granted") {
            initServiceWorker();
            localStorage.setItem("smiggins-push-notifs", "1");
            (_b = document.getElementById("enable-push-notifs")) === null || _b === void 0 ? void 0 : _b.setAttribute("hidden", "");
            (_c = document.getElementById("disable-push-notifs")) === null || _c === void 0 ? void 0 : _c.removeAttribute("hidden");
        }
        else if (perms === "denied") {
            (_d = document.getElementById("enable-push-notifs")) === null || _d === void 0 ? void 0 : _d.setAttribute("hidden", "");
            (_e = document.getElementById("push-notifs-blocked")) === null || _e === void 0 ? void 0 : _e.removeAttribute("hidden");
        }
    });
}
...
function p_settingsCosmetic(element) {
    ...
    (_b = element.querySelector(`#favicon-sel > option[value="${localStorage.getItem("smiggins-favicon")}"]`)) === null || _b === void 0 ? void 0 : _b.setAttribute("selected", "");
    (_c = element.querySelector(`#pfp-shape > option[value="${localStorage.getItem("smiggins-pfp-shape") || "round"}"]`)) === null || _c === void 0 ? void 0 : _c.setAttribute("selected", "");
    (_d = element.querySelector(`#cw-cascading > option[value="${localStorage.getItem("smiggins-cw-cascading") || "email"}"]`)) === null || _d === void 0 ? void 0 : _d.setAttribute("selected", "");
    (_e = element.querySelector(`#language > option[value="${localStorage.getItem("smiggins-language") || L.meta.id}"]`)) === null || _e === void 0 ? void 0 : _e.setAttribute("selected", "");
    if (localStorage.getItem("smiggins-complex-timestamps")) {
        (_f = element.querySelector("#complex-timestamps")) === null || _f === void 0 ? void 0 : _f.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-hide-interactions")) {
        (_g = element.querySelector("#hide-interactions")) === null || _g === void 0 ? void 0 : _g.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-expand-cws")) {
        (_h = element.querySelector("#expand-cws")) === null || _h === void 0 ? void 0 : _h.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-hide-changelog")) {
        (_j = element.querySelector("#hide-changelog")) === null || _j === void 0 ? void 0 : _j.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-no-like-grouping")) {
        (_k = element.querySelector("#no-like-grouping")) === null || _k === void 0 ? void 0 : _k.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-no-load-toasts")) {
        (_l = element.querySelector("#no-load-toasts")) === null || _l === void 0 ? void 0 : _l.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-auto-show-posts")) {
        (_m = element.querySelector("#auto-show")) === null || _m === void 0 ? void 0 : _m.setAttribute("checked", "");
    }
    (_o = element.querySelector("#theme")) === null || _o === void 0 ? void 0 : _o.addEventListener("change", settingsThemeSelection);
    (_p = element.querySelector("#favicon-sel")) === null || _p === void 0 ? void 0 : _p.addEventListener("change", settingsFaviconSelection);
    (_q = element.querySelector("#pfp-shape")) === null || _q === void 0 ? void 0 : _q.addEventListener("change", settingsPFPShapeSelection);
    (_r = element.querySelector("#cw-cascading")) === null || _r === void 0 ? void 0 : _r.addEventListener("change", settingsCWCascadingSelection);
    (_s = element.querySelector("#complex-timestamps")) === null || _s === void 0 ? void 0 : _s.addEventListener("change", genericCheckbox("smiggins-complex-timestamps"));
    (_t = element.querySelector("#hide-interactions")) === null || _t === void 0 ? void 0 : _t.addEventListener("change", genericCheckbox("smiggins-hide-interactions"));
    (_u = element.querySelector("#expand-cws")) === null || _u === void 0 ? void 0 : _u.addEventListener("change", genericCheckbox("smiggins-expand-cws"));
    (_v = element.querySelector("#hide-changelog")) === null || _v === void 0 ? void 0 : _v.addEventListener("change", genericCheckbox("smiggins-hide-changelog"));
    (_w = element.querySelector("#no-like-grouping")) === null || _w === void 0 ? void 0 : _w.addEventListener("change", genericCheckbox("smiggins-no-like-grouping"));
    (_x = element.querySelector("#no-load-toasts")) === null || _x === void 0 ? void 0 : _x.addEventListener("change", genericCheckbox("smiggins-no-load-toasts"));
    (_y = element.querySelector("#auto-show")) === null || _y === void 0 ? void 0 : _y.addEventListener("change", genericCheckbox("smiggins-auto-show-posts"));
    (_z = element.querySelector("#language")) === null || _z === void 0 ? void 0 : _z.addEventListener("change", () => {
        var _a;
        let newLang = (_a = document.getElementById("language")) === null || _a === void 0 ? void 0 : _a.value;
    ...
    (_0 = element.querySelector("#enable-push-notifs")) === null || _0 === void 0 ? void 0 : _0.addEventListener("click", enablePushNotifications);
    (_1 = element.querySelector("#disable-push-notifs")) === null || _1 === void 0 ? void 0 : _1.addEventListener("click", disablePushNotifications);
    if (window.Notification) {
        (_2 = element.querySelector("#push-notifs-unavailable")) === null || _2 === void 0 ? void 0 : _2.setAttribute("hidden", "");
        if (Notification.permission === "granted" && localStorage.getItem("smiggins-push-notifs")) {
            (_3 = element.querySelector("#disable-push-notifs")) === null || _3 === void 0 ? void 0 : _3.removeAttribute("hidden");
        }
        else if (Notification.permission === "denied") {
            (_4 = element.querySelector("#push-notifs-blocked")) === null || _4 === void 0 ? void 0 : _4.removeAttribute("hidden");
        }
        else {
            (_5 = element.querySelector("#enable-push-notifs")) === null || _5 === void 0 ? void 0 : _5.removeAttribute("hidden");
        }
    }
    if (navigator.userAgent.toLowerCase().includes("android") || [
        ...
        let el = element.querySelector("#pwa-warning");
        if (el) {
...
function p_settingsIndex(element) {
    ...
    if ([
        ...
        (_b = element.querySelector("#export-ios-warning")) === null || _b === void 0 ? void 0 : _b.removeAttribute("hidden");
    }
}
...
function p_user(element) {
    ...
    (_c = element.querySelector("#mute")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", toggleMute);
    (_d = element.querySelector("#user-relationship-help")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", createRelationshipHelpModal);
    (_e = element.querySelector("#following-popup")) === null || _e === void 0 ? void 0 : _e.addEventListener("click", () => (createFollowingModal("following", userUsername)));
    (_f = element.querySelector("#followers-popup")) === null || _f === void 0 ? void 0 : _f.addEventListener("click", () => (createFollowingModal("followers", userUsername)));
    hookTimeline(element.querySelector("[id=\"timeline-posts\"]"), element.querySelector("#timeline-carousel"), {
...
function userUpdateStats(displayName, pronouns, bio, colorOne, colorTwo, following, blocking, muting, numFollowing, numFollowers, numPosts, pinned) {
    var _a;
    let userUsername = getUsernameFromPath();
    ...
    if (postsElement) {
        postsElement.innerText = lr(n(L.user.post_count, floatintToNum(numPosts)), { n: c && floatintToStr(numPosts) || "0" });
    }
}
...
function toggleMute(e) {
    let muteButton = e.target;
    if (!muteButton) {
        return;
    }
    let unmute = muteButton.dataset.unmute !== undefined;
...
function renderFollowingTimeline(users, end) {
    ...
    for (const u of users) {
        ...
        if (followingTimelineOffset === null || u.id < followingTimelineOffset[1]) {
            followingTimelineOffset = [0, u.id];
        }
    }
