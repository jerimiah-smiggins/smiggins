...
function p_settingsCosmetic(element) {
    ...
    (_d = element.querySelector(`#language > option[value="${localStorage.getItem("smiggins-language") || L.meta.id}"]`)) === null || _d === void 0 ? void 0 : _d.setAttribute("selected", "");
    if (localStorage.getItem("smiggins-complex-timestamps")) {
        (_e = element.querySelector("#complex-timestamps")) === null || _e === void 0 ? void 0 : _e.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-hide-interactions")) {
        (_f = element.querySelector("#hide-interactions")) === null || _f === void 0 ? void 0 : _f.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-expand-cws")) {
        (_g = element.querySelector("#expand-cws")) === null || _g === void 0 ? void 0 : _g.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-hide-changelog")) {
        (_h = element.querySelector("#hide-changelog")) === null || _h === void 0 ? void 0 : _h.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-no-like-grouping")) {
        (_j = element.querySelector("#no-like-grouping")) === null || _j === void 0 ? void 0 : _j.setAttribute("checked", "");
    }
    if (localStorage.getItem("smiggins-auto-show-posts")) {
        (_k = element.querySelector("#auto-show")) === null || _k === void 0 ? void 0 : _k.setAttribute("checked", "");
    }
    (_l = element.querySelector("#theme")) === null || _l === void 0 ? void 0 : _l.addEventListener("change", settingsThemeSelection);
    (_m = element.querySelector("#pfp-shape")) === null || _m === void 0 ? void 0 : _m.addEventListener("change", settingsPFPShapeSelection);
    (_o = element.querySelector("#cw-cascading")) === null || _o === void 0 ? void 0 : _o.addEventListener("change", settingsCWCascadingSelection);
    (_p = element.querySelector("#complex-timestamps")) === null || _p === void 0 ? void 0 : _p.addEventListener("change", genericCheckbox("smiggins-complex-timestamps"));
    (_q = element.querySelector("#hide-interactions")) === null || _q === void 0 ? void 0 : _q.addEventListener("change", genericCheckbox("smiggins-hide-interactions"));
    (_r = element.querySelector("#expand-cws")) === null || _r === void 0 ? void 0 : _r.addEventListener("change", genericCheckbox("smiggins-expand-cws"));
    (_s = element.querySelector("#hide-changelog")) === null || _s === void 0 ? void 0 : _s.addEventListener("change", genericCheckbox("smiggins-hide-changelog"));
    (_t = element.querySelector("#no-like-grouping")) === null || _t === void 0 ? void 0 : _t.addEventListener("change", genericCheckbox("smiggins-no-like-grouping"));
    (_u = element.querySelector("#auto-show")) === null || _u === void 0 ? void 0 : _u.addEventListener("change", genericCheckbox("smiggins-auto-show-posts"));
    (_v = element.querySelector("#language")) === null || _v === void 0 ? void 0 : _v.addEventListener("change", () => {
        var _a;
