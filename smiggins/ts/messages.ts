              ...
              <div class="upper-content">
                <a href="/u/${message.username}" class="no-underline text">
                  <div class="displ-name">
                    ...
                    ${message.badges.length ? `<span aria-hidden="true" class="user-badge">${message.badges.map((icon) => (badges[icon])).join("</span> <span aria-hidden=\"true\" class=\"user-badge\">")}</span>` : ""}<br>
