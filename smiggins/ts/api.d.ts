type apiErrors = "BAD_USERNAME" | "USERNAME_USED" | "BAD_PASSWORD" | "RATELIMIT" | "INVALID_OTP" | "NOT_AUTHENTICATED" | "POLL_SINGLE_OPTION" | "CANT_INTERACT" | "BLOCKING" | "POST_NOT_FOUND";
