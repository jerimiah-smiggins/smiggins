const icons: { [key in icons]: string } = {
  ...
  search: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M432 272c0-88.4-71.6-160-160-160s-160 71.6-160 160 71.6 160 160 160 160-71.6 160-160m-30.9 163.1C365.7 463.2 320.8 480 272 480c-114.9 0-208-93.1-208-208S157.1 64 272 64s208 93.1 208 208c0 48.8-16.8 93.7-44.9 129.1L569 535c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0z"/></svg>',
